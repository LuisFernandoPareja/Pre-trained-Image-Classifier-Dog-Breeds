...
def calculates_results_stats(results_dic):
    ...
    for i in results_dic:
        # Dog or not dog images
        if results_dic[i][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
        elif results_dic[i][3] == 0:
        ...
        # correct dogs/notdogs
        if results_dic[i][3] == 1 and results_dic[i][4] == 1:
            results_stats_dic['n_correct_dogs'] += 1
        elif results_dic[i][3] == 0 and results_dic[i][4] ==0:
    ...
    try:
        ...
        # Percentage of Correctly Classified Dog Image
